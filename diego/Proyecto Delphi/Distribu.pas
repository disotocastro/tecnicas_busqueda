...
var
  ...
  NumLugares, ConteoPermutaciones: Integer;

  procedure ProbarDistribucion(indice: Integer; RecursosRestantes: Integer; GananciaAcumulada: Integer; var Conteo: Integer);
  var
    r: Integer;
  begin
    ...
    begin
      ...
      // Incrementa el conteo de permutaciones
      Inc(Conteo);
    ...
    begin
      ...
      if r <= High(Tabla) then
        ProbarDistribucion(indice + 1, RecursosRestantes - r, GananciaAcumulada + Tabla[r][indice], Conteo);
    end;
  end;
...
begin
  ...
  MejorGanancia := 0;
  ConteoPermutaciones := 0;

  ProbarDistribucion(0, RecursoTotal, 0, ConteoPermutaciones);

  // Imprime el resultado y el total de permutaciones
  ...
  WriteLn('Total de permutaciones: ', ConteoPermutaciones);
end;
